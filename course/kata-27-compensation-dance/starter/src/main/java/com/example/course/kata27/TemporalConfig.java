...
public class TemporalConfig {
    ...
    public static final String TASK_QUEUE = "course-kata-27";
    ...
    @Bean
    public Worker kataWorker(WorkerFactory workerFactory, OrderActivities orderActivities) {
        Worker worker = workerFactory.newWorker(TASK_QUEUE);
        worker.registerWorkflowImplementationTypes(FullOrderSagaWorkflowImpl.class);
