...
public class TemporalConfig {
    ...
    public static final String TASK_QUEUE = "kata-03";
    ...
    @Bean
    public Worker katasWorker(WorkerFactory workerFactory, NotificationActivities notifications) {
        Worker worker = workerFactory.newWorker(TASK_QUEUE);
        worker.registerWorkflowImplementationTypes(HighValueOrderWorkflowImpl.class);
