...
public class TemporalConfig {
    ...
    public static final String TASK_QUEUE = "order-service";
    ...
    /**
     * Registers the workflow only. The activities it calls run in payment-service,
     * inventory-service and shipping-service, on their own task queues.
     */
    @Bean
