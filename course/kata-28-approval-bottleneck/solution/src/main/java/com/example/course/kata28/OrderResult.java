...
public class OrderResult {
    ...
    private String status;   // COMPLETED, FAILED or REJECTED
    ...
    /** Approval refused or timed out. The order id is available from the getApprovalStatus() query. */
    public static OrderResult rejected(String reason) {
        return new OrderResult(null, "REJECTED", reason);
    }
